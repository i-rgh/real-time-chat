...
<template>
    <div class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-800 text-white p-4">
        ...
        <ul  v-if="users?.length">
            <li v-for="user in users as User[]" :key="user.data.id" class="flex items-center space-x-2 cursor-pointer hover:bg-gray-700 p-2 rounded-lg" @click="selectUser(user)">
